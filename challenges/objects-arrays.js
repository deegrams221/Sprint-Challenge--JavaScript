...
// 		let universitySort = graduates[i].university;
// 		universities.push(universitySort);
// 	}
// 	alphabetical = universities.sort();
// console.log(universities)

const universities = [];
	graduates.forEach((graduates) => {
		let universitySort = graduates.university;
		universities.push(universitySort);
	});
	alphabetical = universities.sort();
console.log(universities)
...
const uni = [];
	graduates.forEach((graduates) => {
		if (graduates.university.toLowerCase().includes('uni')) {
...
zooAnimals.forEach((animal) => {
    let name = `Name: ${animal.animal_name}, Scientific: ${animal.scientific_name}.`;
